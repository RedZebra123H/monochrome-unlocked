...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    {
        const repo = 'https://github.com/RedZebra123H/monochrome-unlocked';
        ...
        const commitLink =
            hash !== 'dev' && hash !== 'unknown'
                ...
                : hash;
        const repoLink = `<a href="${repo}" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">RedZebra123H/monochrome-unlocked</a>`;
