define(['exports'], function (t) {
    ...
    function x(t) {
        return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
            ? (
                ...
                ? function (...e) {
                      return (t.apply(I(this), e), C(v.get(this)));
                  }
                : function (...e) {
                      return C(t.apply(I(this), e));
                  }
            : function (e, ...s) {
                  const n = t.call(I(this), e, ...s);
                  return (b.set(n, e.sort ? e.sort() : [e]), C(n));
              };
    }
    function L(t) {
            ...
            (this.l(t),
                this.u &&
                    (function (t, { blocked: e } = {}) {
                        ...
                        (e && s.addEventListener('blocked', (t) => e(t.oldVersion, t)), C(s).then(() => {}));
                    })(this.u));
        }
                        ...
                        return (
                            n &&
                                a.addEventListener('upgradeneeded', (t) => {
                                    n(C(a.result), t.oldVersion, t.newVersion, C(a.transaction), t);
                                }),
    ...
    class P {
        ...
        async delete() {
            ((this.R = !1), await this.L.expireEntries(1 / 0));
        }
    }
    function j(t, e) {
        const s = new URL(t);
    ...
    class K {
        ...
        async fetch(t) {
            ...
            try {
                let t;
                t = await fetch(n, 'navigate' === n.mode ? void 0 : this.C.fetchOptions);
        ...
        async getCacheKey(t, e) {
            ...
            if (!this._[s]) {
                ...
                for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
                    n = W(await t({ mode: e, request: n, event: this.event, params: this.params }));
                this._[s] = n;
            }
            return this._[s];
        }
    ...
    class A {
        ...
        handleAll(t) {
            ...
            const e = t.event,
                ...
                r = new K(this, { event: e, request: s, params: n }),
                i = this.T(r, s, e);
        ...
        async T(t, e, n) {
            ...
            try {
                if (((r = await this.P(e, t)), !r || 'error' === r.type)) throw new s('no-response', { url: e.url });
            } catch (s) {
    ...
    class X extends A {
        ...
        async P(t, e) {
            ...
            return s || (e.event && 'install' === e.event.type ? await this.W(t, e) : await this.K(t, e));
        }
        async K(t, e) {
            let n;
            const r = e.params || {};
            if (!this.S) throw new s('missing-precache-entry', { cacheName: this.cacheName, url: t.url });
            {
                const s = r.integrity,
                    i = t.integrity,
                    a = !i || i === s;
        ...
        (t.RangeRequestsPlugin = class {
            constructor() {
                this.cachedResponseWillBeUsed = async ({ request: t, cachedResponse: e }) =>
                    e && t.headers.has('range') ? await F(t, e) : e;
            }
        }),
