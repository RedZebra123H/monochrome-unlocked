const f = '0.12.9',
    R = `https://unpkg.com/@ffmpeg/core@${f}/dist/umd/ffmpeg-core.js`;
var E;
(function (t) {
    ((t.LOAD = 'LOAD'),
        (t.EXEC = 'EXEC'),
...
const u = new Error('unknown message type'),
    O = new Error('ffmpeg is not loaded, call `await ffmpeg.load()` first'),
    m = new Error('failed to import ffmpeg-core.js');
let r;
const l = async ({ coreURL: t, wasmURL: n, workerURL: e }) => {
    ...
    I = ({ path: t, data: n }) => (r.FS.writeFile(t, n), !0),
    L = ({ path: t, encoding: n }) => r.FS.readFile(t, { encoding: n }),
    N = ({ path: t }) => (r.FS.unlink(t), !0),
    A = ({ oldPath: t, newPath: n }) => (r.FS.rename(t, n), !0),
    k = ({ path: t }) => (r.FS.mkdir(t), !0),
    w = ({ path: t }) => {
    ...
    b = ({ path: t }) => (r.FS.rmdir(t), !0),
    p = ({ fsType: t, options: n, mountPoint: e }) => {
        const o = t,
